...
class BetaVAE(BaseVAE):
    ...
    def loss_function(self, *args, **kwargs) -> dict:
        self.num_iter += 1
        beta = min(self.beta + 0.001 * self.num_iter, self.beta_max) #added
        recons = args[0]
        input = args[1]
        mu = args[2]
        log_var = args[3]
        ...
        if self.loss_type == "H":  # https://openreview.net/forum?id=Sy2fzU9gl
            loss = recons_loss + beta * kld_weight * kld_loss #self.beta -> beta
        ...
        return {
            ...
            "KLD": kld_loss,
            "KLD_Scaled": beta * kld_weight * kld_loss
        }
